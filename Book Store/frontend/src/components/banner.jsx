            ...
            <div className="max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-6">
                <div className="order-2 md:order-1 w-full md:1/2 mt-12 md:mt-32">
                    <div className="space-y-12">
                        ...
                        <h1 className="text-4xl font-bold">Hello, welcome here, learn every day something new <span className="text-pink-500">Everyday</span></h1>
                ...
                <div className="order-1 md:order-2 w-full md:1/2">
